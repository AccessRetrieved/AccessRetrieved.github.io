...
_recipes_pil_prescript(['PalmImagePlugin', 'PsdImagePlugin', 'MspImagePlugin', 'MicImagePlugin', 'SpiderImagePlugin', 'GbrImagePlugin', 'PixarImagePlugin', 'BlpImagePlugin', 'DdsImagePlugin', 'EpsImagePlugin', 'GifImagePlugin', 'Hdf5StubImagePlugin', 'FpxImagePlugin', 'GribStubImagePlugin', 'PngImagePlugin', 'MpoImagePlugin', 'FliImagePlugin', 'WebPImagePlugin', 'IcoImagePlugin', 'SgiImagePlugin', 'DcxImagePlugin', 'McIdasImagePlugin', 'XVThumbImagePlugin', 'ImImagePlugin', 'TiffImagePlugin', 'SunImagePlugin', 'CurImagePlugin', 'XbmImagePlugin', 'BmpImagePlugin', 'PpmImagePlugin', 'BufrStubImagePlugin', 'ImtImagePlugin', 'Jpeg2KImagePlugin', 'FtexImagePlugin', 'TgaImagePlugin', 'IcnsImagePlugin', 'PcdImagePlugin', 'XpmImagePlugin', 'WmfImagePlugin', 'PcxImagePlugin', 'PdfImagePlugin', 'IptcImagePlugin', 'JpegImagePlugin', 'MpegImagePlugin', 'FitsStubImagePlugin'])
