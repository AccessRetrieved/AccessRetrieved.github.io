...
preloadImages([
    ...
    'https://raw.githubusercontent.com/AccessRetrieved/server/main/Music/cover/奔赴星空.png',
...
function check1() {
    // Check if phone, and redirect to source
    let check = false;
    ...
    if (check == true) {
      ...
      if (sourceURL.includes('index.html') == true) {
        window.location = 'https://accessretrieved.github.io/Music/index_phone.html';
      } else if (sourceURL.includes('discover.html') == true) {
        window.location = 'https://accessretrieved.github.io/Music/discover_phone.html';
      } else if (sourceURL.includes('library.html') == true) {
        window.location = 'https://accessretrieved.github.io/Music/library_phone.html.html';
      } else {
        alert('出错了，请稍后尝试');
        //window.location = 'https://accessretrieved.github.io/Music/index_phone.html';
      }
