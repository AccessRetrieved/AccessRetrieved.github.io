    ...
    var a = function b(c, d, e) {
        ...
        1: [function(a, b, c) {
            ...
            f.prototype.event = function(a) {
                return d.isObject(a) ? (d.assert(a.event, "a.event no event"),
                d.assert(a.listener, "a.event no listener"),
                [a.event, a.listener].join(".")) : a
            }
            ,
            f.prototype.add = function(a, b, c, d) {
                ...
                return this.data.hasOwnProperty(a) ? this.data[a].push(e) : this.data[a] = [e],
                this
            }
            ,
            ...
            f.prototype.off = function(a, b) {
                ...
                var c = d.reduce(this.data[a], function(a, c) {
                    return d.isNone(b) || c.func !== b ? d.isNone(b) ? a : (a.push(c),
                    a) : a
                }, []);
                return 0 === c.length ? delete this.data[a] : this.data[a] = c,
                this
            }
            ,
            ...
            f.prototype.get = function(a, b, c, e) {
                ...
                b || (b = {}),
                d.assert(c),
                b.hasOwnProperty("listener") || (b.listener = "l" + d.getUUID()),
                this.one({
                    event: a,
                    listener: b.listener
                }, c, e),
            ...
            f.prototype.listeners = function(a) {
                return d.reduce(this.data, function(b, c, d) {
                    var e = d.split(".");
                    return 2 === e.length && e[0] === a && b.push(e[1]),
                    b
                }, [])
            }
            ,
        ...
        2: [function(a, b, c) {
            ...
            g.Keeper.prototype = {
                ...
                each: function(a) {
                    if (this.results[a.original_url] = a,
                    this.count++,
            ...
            g.API.prototype.init = function(a) {
                d.isString(a) ? this.key = a : d.isNone(a) || (this.key = a.key),
                this.key = this.key ? this.key : f.EMB_API_KEY,
                this.protocol = "http:" === window.location.protocol ? "http:" : "https:"
            }
            ,
            g.API.prototype._buildUrl = function(a, b) {
                if (d.isNone(this.key))
                    return null;
            ...
            g.API.prototype._data = function(a, b, c, f) {
                if (e.console.log(a, b, c, f),
                d.isNone(f) && d.isFunction(c) && (f = c,
                c = {}),
                d.isNone(f))
                    return !1;
                if (d.isString(b)) {
        ...
        4: [function(a, b, c) {
            ...
            h.animateScroll = function(a, b) {
                var c, d, f = h.window.scrollY(), g = a - f, i = (new Date).getTime(), j = !1;
                b = b ? b : 500;
        ...
        5: [function(a, b, c) {
            ...
            f.extend = function(a) {
                ...
                d = !1;
                for (var g in a)
                    f[g] = "function" == typeof a[g] && "function" == typeof c[g] && e.test(a[g]) ? function(a, b) {
                        return function() {
                            var d = this._super;
                            this._super = c[a];
        ...
        6: [function(a, b, c) {
            ...
            f.EVENTS = ["xcomm.options.access", "xcomm.media.recommend", "xcomm.card.recommend", "xcomm.log.event", "xcomm.page.progress"],
            f.clear = function() {
                f.instance && (f.instance.remove(),
                f.instance = null),
                f.started = !1
            }
            ,
        ...
        7: [function(a, b, c) {
            ...
            f.create = function(a, b, c, e) {
                if (!a || !d.isString(a))
                    return null;
                d.isString(b) && d.isNone(c) && (c = b,
                b = {});
                var g;
                return g = e ? document.createElementNS("http://www.w3.org/2000/svg", a) : document.createElement(a),
            ...
            f.replace = function(a, b) {
                d.assert(d.isElement(a), "replace requires an element to be replaced"),
                d.assert(d.isElement(b), "replace requires an element to replace with."),
            ...
            f.show = function(a, b) {
                return d.isString(a) && (a = f.one(a)),
                d.isElement(a) && (a.style.display = b ? "inline-block" : "block"),
                a
            }
            ,
                    ...
                    if (d.isElement(c)) {
                        if (!d.isNone(b))
                            if (c.namespaceURI && "http://www.w3.org/2000/svg" === c.namespaceURI) {
                                if (c.nodeName !== b)
                                    return a
                            } else if (b.toUpperCase() !== c.nodeName)
                                return a;
                        a.push(c)
                    }
                    return a
            ...
            f.removeClass = function(a, b) {
                ...
                return a.setAttribute("class", g.join(" ")),
                e
            }
            ,
            ...
            f.event = function(a) {
                ...
                return b.target || (b.target = b.srcElement || document),
                ...
                ,
                b.pageX || b.pageY || !b.clientX && !b.clientY || (b.pageX = b.clientX + document.body.scrollLeft + document.documentElement.scrollLeft,
                b.pageY = b.clientY + document.body.scrollTop + document.documentElement.scrollTop),
                b
            }
            ,
            ...
            f.trigger = function(a, b) {
                ...
                var c;
                a.dispatchEvent ? (c = document.createEvent("MouseEvents"),
                c.initEvent(b, !0, !0),
                a.dispatchEvent(c, !0)) : (c = document.createEventObject(),
                a.fireEvent("on" + b, c))
            }
            ,
            f.rect = function(a) {
        ...
        8: [function(a, b, c) {
            ...
            h.add.cards = function(a) {
                if (d.isString(a)) {
                    ...
                    if (!a.selector && !a.types)
                        return !1;
                    var b = {};
                    if (d.isArray(a.types) && a.types.length > 0 && (b.types = a.types),
                    a.selector)
                        b.selector = a.selector,
                        h.selectors.cards.push(b);
                    else {
            ...
            h.add.button = function(a) {
                d.isString(a) && (h.selectors.button.push(a),
                h.look())
            }
            ,
            ...
            h.each = function(a) {
                ...
                if ("A" === a.nodeName || "BLOCKQUOTE" === a.nodeName)
                    for (b = 0; b < h.selectors.cards.length; b++)
                        if (c = h.selectors.cards[b],
                        h.select(c.selector, a))
                            return a._em_opts = c,
                            {
                                name: "card",
                                node: a
                ...
                if ("IFRAME" === a.nodeName) {
                    ...
                    if (a.src && /\/\/cdn\.embedly\.com\/widgets\/media\.html/.test(a.src))
                        return {
                            name: "iframe",
                            node: a
                        };
            ...
            h.release = function() {
                var a = h._queue;
                h._queue = [],
                a = d.reduce(a, function(a, b) {
                    return d.contains(a, b) ? a : b.className && "embd-" === b.className.substr(0, 5) ? a : (a.push(b),
                    a)
                }, []);
                var b = d.reduce(a, function(a, b) {
                    var c = h.each(b);
                    return c && a[c.name + "s"].push(c.node),
                    a
                }, {
                    cards: [],
                    buttons: [],
        ...
        10: [function(a, b, c) {
            ...
            j.connect = function(a, b, c) {
                ...
                i.send = function(a, b, c) {
                    ...
                    b.method = a,
                    m === !1 && !c)
                        return g.console.log("frame.queue", b),
                        l.push(b),
                        !1;
                    if (i.sid && (b.sid = i.sid),
                ...
                ,
                i.ready = function() {
                    m || (g.console.log("frame.ready", i.name),
                    m = !0,
                    d.each(l, function(a) {
                        i.send(a.method, a)
                    }))
                ...
                var o = function(a, b) {
                    if (a.origin === j || null === j || "about:" === a.origin) {
                        if (!b.src && !b.sid && !b.listener)
                            return !1;
                        if (i.sid && b.sid !== i.sid)
                            return !1;
                        if (b.src && b.src !== n)
                            return !1;
                        g.console.log("frame.message", b),
                        k.notify("message", b)
                    }
                };
                return c.on("window.message", o),
                i._remove = function() {
            ...
            j.rendering = function(a) {
                return "1" === e.data(a, "rendering") ? !0 : (e.data(a, "rendering", "1"),
                !1)
            }
            ,
            j.create = function(a, b, c, f, g) {
                ...
                c.sid = h;
                var k = d.extend({}, f);
                c.sandbox === !1 && (k.src = i.EMB_FRAME_SRC + a + ".html#sid=" + h),
        ...
        12: [function(a, b, c) {
            ...
            m.css = function() {
                ...
                return m._css || (m._css = null),
                m._css
            }
            ,
            m.options = function(a) {
                if (!e.isElement(a) || !e.isElement(a.parentNode))
                    return null;
                var b = {
                    sandbox: !0
                };
                ...
                "BLOCKQUOTE" === a.nodeName) {
                    ...
                    if (e.isNone(i)) {
                        ...
                        b.url = d.getAttribute("href"),
                        b.title = f.text(d),
                        e.isNone(j) ? b.description = "0" : b.description = f.text(j)
                } else
                    "A" === a.nodeName && (b.url = a.getAttribute("href"));
                ...
                if (e.each(document.getElementsByTagName("meta"), function(a) {
                    ...
                    e.contains(n, "twitter:site") ? l = a.getAttribute("content") : e.contains(n, "twitter:creator") && (k = a.getAttribute("content"))
                }),
                k ? b.twitter_via = k : l && (b.twitter_via = l),
                !b.url)
                    return null;
                var o = g.parse(b.url);
                return o.valid() ? (b.url = o.url,
                b.sandbox = m.sandbox(b.url),
                b.referrer || (b.referrer = document.URL),
                b.width && (b.width = m.cleanWidth(b.width)),
                /thescore\.com/.test(b.referrer) && (b.key = "900b122ee8ee43f79b2240c831f24429"),
                b) : null
            }
            ;
            ...
            m.fetch = function(a, b, c, f) {
                ...
                c = e.reduce(c, function(c, d, e) {
                    ...
                    return m.extractless.test(d.url) ? f.extract({}) : f.error || c.push(d),
                    h.push(f),
                    c
                }, []);
                var j = e.reduce(c, function(a, b) {
                    return a.push(b.url),
                    b.embed && a.push(b.embed),
                    a
                }, []);
                if (!j.length)
                    return e.isFunction(f) && f(e.map(h, function(a) {
                        return a.frame
                    })),
                    e.map(h, function(a) {
                        return a.frame
                ...
                return c.protocol && (o = c.protocol),
                o = o.split(":")[0],
            ...
            m.build = function(a, b, c) {
                ...
                return h.isFirefox() && (d.elem.style.visibility = "visible",
                ...
                d.on("card.rendered", function(b) {
                    ...
                    d.type = b.type,
                    "error" === b.name)
                        return d.__hub.notify("card.error", a),
                        d.remove(),
                        !1;
                    if (a._em_opts) {
                        var g = e.extend({}, a._em_opts);
                        if (delete a._em_opts,
                        e.isArray(g.types) && g.types.length > 0 && !e.contains(g.types, b.type))
                            return d.__hub.notify("card.error", a),
                            d.remove(),
                            !1
                    }
                    d.rendered = !0,
                    !d.options.twitter_via && b.defaultTwitterVia && (d.options.twitter_via = b.defaultTwitterVia);
                    ...
                    b.height ? d.elem.height = b.height : d.elem.height = "300",
                    b.width ? m.isPercent(b.width) ? (h.style.width = b.width,
                    d.elem.width = "100%") : (d.elem.width = b.width,
                    h.style.maxWidth = b.width + "px") : (d.elem.width = "600",
                    h.style.maxWidth = "600px"),
                    h.style.padding = "0",
                    h.style.position = "relative",
                    h.style.minWidth = "200px",
                    "left" === b.align ? h.style.margin = "5px 0" : "right" === b.align ? h.style.margin = "5px 0 5px auto" : h.style.margin = "5px auto",
                    d.elem.style.width = null,
                    d.elem.style.height = null,
                    d.elem.style.maxWidth = "100%",
                    d.elem.style.minWidth = "200px",
                    f.remove(a),
                    "error" !== b.type && (c.notify("card.rendered", d.elem, d),
                    b.controls && k.card(d))
                }),
            ...
            m.multi = function(a, b, c, d) {
                return a = e.reduce(a, function(a, b) {
                    return j.rendering(b) ? a : (a.push(b),
                    a)
                }, []),
        ...
        13: [function(a, b, c) {
            ...
            i.one = function(a, b) {
                ...
                j.src = h.EMB_SECURE_FRAME_SRC + "xcomm.html#" + f.createQuery(b);
        ...
        14: [function(a, b, c) {
            ...
            h.one = function(a, b) {
                ...
                "window" === a.target)
                    return e.open("http://cdn.embedly.com/widgets/embed?url=" + encodeURIComponent(a.url), "Embed Code", 635, 500),
                    !1;
                a.t = "card";
        ...
        15: [function(a, b, c) {
            ...
            j.options = function(a, b) {
                if (!d.isElement(a) || !d.isElement(a.parentNode))
                    return null;
            ...
            j.one = function(a, b, c) {
                ...
                k.on("slideshow.rendered", function(b) {
                    return k.ready(),
                    "error" === b.name ? (k.remove(),
                    k.__hub.notify("slideshow.error", a),
                    !1) : (k.rendered = !0,
                    ...
                    k.elem.width = "700",
                    b.height ? k.elem.height = b.height : k.elem.height = "500",
                    b.width ? k.elem.width = b.width : k.elem.width = "700",
        ...
        16: [function(a, b, c) {
            ...
            f.Sender = e.extend({
                ...
                event: function(a, b, c) {
                    ...
                    return d.contains(this.sent, e) ? !1 : (this.sent.push(e),
                    void this.send(a, b, c))
                },
                send: function() {}
            }),
            ...
            f.event = function(a, b, c) {
                return a && b && c && "click" === b ? (d.contains(["facebook", "twitter", "pinterest", "repeat"], a) && (b = a,
                a = "social"),
                "article-full" === a && (a = "article"),
                d.contains(["video", "image", "rich", "article", "product", "social", "recommend"], a) ? (a = d.capitalize(a),
                b = d.capitalize(b),
                void f.send(a, b, c)) : !1) : !1
            }
            ,
        ...
        17: [function(a, b, c) {
            ...
            e.prototype.done = function() {
                ...
                if (this.count === this.len) {
                    ...
                    return this.func.call(this.ctx, a),
                    !0
                }
            }
            ,
                ...
                window.libringEventAPI = window.libringEventAPI || {
                    track: function(a, b, c) {
                        try {
                            ...
                            d.send('{"accessCode":"7AMXYZIYIVEDFM3CRPHEH33WQQ","data":[{"eventType":"' + a + '","values":{"url":"' + b + '","category":"' + c + '"}}]}')
                        } catch (e) {
                            return !1
                        }
                    }
        ...
        19: [function(a, b, c) {
            ...
            g.queue = function(a) {
                ...
                g._queue.push(a),
                g.comms() && (g.timeout = setTimeout(function() {
                    g.release()
                }, 50))
            }
            ,
            g.event = function(a) {
                ...
                window.self === window.top ? (b.r = document.location.toString(),
                b.rr = document.referrer) : b.r = document.referrer,
                d.assert(a.g),
                d.assert(a.c),
                d.assert(a.a),
                b = d.extend({}, b, a),
                "reddit" !== b.c || "load" !== b.a && "click" !== b.a && "view" !== b.a || !window.libringEventAPI || window.libringEventAPI.track(b.a, b.u, b.r)
            }
            ,
            g.comms = function() {
                return g.connected ? !0 : g.hub ? g.connecting ? !1 : (g.connecting = !0,
                g.hub.one("xcomm.ready", function() {
                    g.connected = !0,
                    g.release()
                }),
                void f.connect(g.hub, {
                    name: g.name
                })) : !1
            }
            ,
        ...
        20: [function(a, b, c) {
            ...
            f.recurse = function(a) {
                var b = [];
                return e.isElement(a) && b.push(a),
                e.reduce(a.childNodes, function(a, b) {
            ...
            f.observer = function(a) {
                ...
                return f._observer.observe(b, c),
                !0
            }
            ,
            f.events = function(a) {
            ...
            f.stop = function() {
                var a = f.html();
                return null === a ? !1 : (f._event && (d.detachEvent(a, "DOMNodeInserted", f._event),
                f._event = null),
                void (f._observer && (f._observer.disconnect(),
                f._observer = null)))
            }
            ,
            f.connect = function(a) {
        ...
        21: [function(a, b, c) {
            ...
            h.connect = function(a, b) {
                ...
                if (!b && g.PAGE_PROGRESS_DOMAINS && !d.contains(g.PAGE_PROGRESS_DOMAINS, c))
                    return !1;
                if (h.started)
                    return !1;
                h.started = !0;
        ...
        22: [function(a, b, c) {
            function d(a) {
                return function() {
                    ...
                    /^get/.test(a) ? (e.assert(c.length > 0, "Get methods require a callback."),
                    c.unshift(b)) : (/^set/.test(a) && (e.assert(0 !== c.length, "Set methods require a value."),
                    b.value = c[0]),
                    c = [b]),
            ...
            g.Player.prototype.send = function(a, b, c) {
                ...
                a.version = g.VERSION,
                b ? (a.listener = "l" + e.getUUID(),
                this.frame.one({
                    event: a.method,
                    listener: a.listener
                }, g.bound(b, c), c)) : this.frame.on(a.method, b, c),
            ...
            g.Player.prototype.on = function(a, b, c) {
                ...
                return "ready" === a ? this.frame.one(f, g.bound(b, c), c) : this.frame.on(f, g.bound(b, c), c),
            ...
            g.Player.prototype.supports = function(a, b) {
                e.assert(e.indexOf(["method", "event"], a) > -1, 'evtOrMethod needs to be either "event" or "method" got ' + a),
                b = e.isArray(b) ? b : [b];
                for (var c = "event" === a ? this.events : this.methods, d = 0; d < b.length; d++)
                    if (-1 === g.indexOf(c, b[d]))
                        return !1;
                return !0
            }
            ,
        ...
        23: [function(a, b, c) {
            ...
            g.prototype.ready = function() {
                return this.isReady ? !1 : (this.isReady = !1,
            ...
            g.prototype.elem = function(a, b, c) {
                ...
                a.onreadystatechange = function() {
                    var b = a.readyState;
                    ("loaded" === b || "complete" === b) && (a.onreadystatechange = null,
                    e())
                }
                ,
                e
            ...
            g.prototype.script = function(a, b, c, e) {
                ...
                f.src = a,
                d.isNone(e) || d.each(e, function(a, b) {
                    f.setAttribute(b, a)
                }),
                this.elem(f, b, c),
                this.appendToHead(f),
        ...
        24: [function(a, b, c) {
            ...
            f.add = function(a, b) {
                ...
                if (f.enabled) {
                    ...
                    f.options.hasOwnProperty(a.elem) && (g = e.extend(g, f.options[a.elem])),
            ...
            f.connect = function(a) {
                a.on("media.recommend.options", function(b, c, d) {
                    f.enabled = !0,
                    null === b ? f.defaults = c : e.isElement(b) && (f.options[b] = c),
                    e.each(d, function(b) {
        ...
        25: [function(a, b, c) {
            ...
            j.buttons = function(a) {
                ...
                return d.each(["facebook", "twitter", "pinterest", "linkedin", "card"], function(d) {
                    ...
                    b.innerHTML = "<i></i>",
                    j.buttons[d].call(window, b, a) === !0 && c.appendChild(b)
                }),
                c
            }
            ,
            j.buttons.twitter = function(a, b) {
                ...
                return f && (i.text = d.truncate(f, 100)),
                h ? i.via = "@" === h.substr(0, 1) ? h.substr(1) : h : i.via = "embedly",
                a.href = "https://twitter.com/intent/tweet?" + g.createQuery(i),
                e.addEvent(a, "click", function(c) {
                    var d = e.event(c);
                    d.stop(),
                    window.open(a.href, "_blank", "width=550,height=410,top=150,left=150"),
            ...
            j.buttons.facebook = function(a, b) {
                ...
                return a.href = "https://www.facebook.com/sharer/sharer.php?" + g.createQuery(c),
                e.addEvent(a, "click", function(c) {
                    var d = e.event(c);
                    d.stop(),
                    window.open(a.href, "_blank", "width=700,height=425,top=150,left=150"),
            ...
            j.buttons.linkedin = function(a, b) {
                ...
                return a.href = "https://www.linkedin.com/shareArticle?" + g.createQuery(c),
                e.addEvent(a, "click", function(c) {
                    var d = e.event(c);
                    d.stop(),
                    window.open(a.href, "_blank", "width=700,height=425,top=150,left=150"),
            ...
            j.buttons.embedly = function(a, b) {
                ...
                return a.href = g.appendQuery("http://embed.ly/cards", c),
                a.target = "_blank",
        ...
        26: [function(a, b, c) {
            ...
            g.replace = function(a, b) {
                if (d.isNone(a) || !d.isElement(a))
                    return null;
                if ("IFRAME" !== a.nodeName)
                    return null;
                if (!a.src || !d.isString(a.src))
                    return null;
                if (!b.key)
                    return !1;
                var c = a.src;
        ...
        27: [function(a, b, c) {
            ...
            e.Tunnel.prototype.connect = function(a) {
                this.child = a,
                this.child.on("receiver.send", d.bind(function(a, b) {
                    d.isNone(b) && (b = {}),
                    b.method = a,
        ...
        28: [function(a, b, c) {
            ...
            e.appendQuery = function(a, b) {
                ...
                var c = a.split("?")
                  , f = c[0];
                if (!b || !d.isObject(b) || d.isEmptyObject(b))
                    return a;
                var g = e.getQuery(a);
                return g = d.extend(g, b),
            ...
            e.removeQuery = function(a, b) {
                ...
                var c = a.split("?")
                  , f = c[0]
                  , g = e.getQuery(a);
                return g.hasOwnProperty(b) && delete g[b],
            ...
            e.parse = function(a) {
                ...
                return a ? /^https?:\/\/[^\/]+\.[^\/]/i.test(a) ? (f.valid(!0),
                f) : /^\w+:/i.test(a) ? f : "#" === a[0] ? f : /^\/\/[^\/]+\.[^\/]/i.test(a) ? (f.valid(!0),
                f.url = c + a,
                f) : /^\/([^\/]+|$)/i.test(a) ? (f.valid(!0),
            ...
            e.sanitize = function(a) {
                return a ? (a = a.replace(/#x\d\d;/, ""),
                a.replace(/[^-A-Za-z0-9+&@#\/%?=~_|!:,.;\(\)]/g, "")) : a
            }
            ,
            b.exports = e
        }
        ...
        29: [function(a, b, c) {
                ...
                if (null != a)
                    if (l && a.forEach === l)
                        ...
                        for (var d = 0, e = a.length; e > d; d++)
                            if (d in a && b.call(c, a[d], d, a) === f)
                                return
                    } else
                        for (var g in a)
                            if (h.hasOwnProperty.call(a, g) && b.call(c, a[g], g, a) === f)
                                return
            }
            ,
            ...
            e.reduce = function(a, b, c, d) {
                ...
                m && a.reduce === m)
                    ...
                    f ? a.reduce(b, c) : a.reduce(b);
                if (e.each(a, function(a, e, g) {
                    f ? c = b.call(d, c, a, e, g) : (c = a,
                    f = !0)
                }),
                !f)
            ...
            e.bind = function(a, b) {
                var c, d;
                if (p && a.bind === p)
                    return p.apply(a, j.call(arguments, 1));
                if (!e.isFunction(a))
                    throw new TypeError;
            ...
            e.camelCase = function(a, b) {
                var c = a.split("-");
                return b = b ? b : c.length,
                c.length > 1 && (a = c.splice(0, 1)[0],
                a += e.map(c.splice(0, b), function(a) {
        ...
        30: [function(a, b, c) {
            ...
            g.prototype.listen = function() {
                return this._listening ? !1 : (this._listening = !0,
        ...
        31: [function(a, b, c) {
            ...
            var A = function(a, b, c) {
                var e;
                if (f.isFunction(b) && (c = b,
                b = {}),
                f.isString(a) || !f.isElement(a) && f.isObject(a))
                    return m.add.cards(a),
                    !0;
              ...
              , B = function(a) {
                var b;
                return f.isString(a) ? (m.add.button(a),
                !0) : (f.isElement(a) && "a" === a.nodeName.toLowerCase() && (b = d.button.one(a, u)),
                b && b.on("button.rendered", function() {
              ...
              , C = function(a, b) {
                ...
                return f.isFunction(b) && b.call(e, e),
                e
            }
              , D = function(a, b, c) {
                var e = d.slideshow.one(a, b, u);
                return f.isFunction(c) && c.call(e, e),
                e
            }
              , E = function(a) {
                if ("1" === h.data(a, "connected"))
                    return !1;
              ...
              , G = function(a, b) {
                ...
                if (f.isString(b)) {
                    ...
                    f.each(y.media, function(d) {
                        d.elem === a && (c = !0,
                        u.notify("media.recommend." + b, d, d.elem))
                    }),
                    c || u.notify("media.recommend." + b, null, a)
                } else
                    f.isObject(b) && u.notify("media.recommend.options", a, b, y.media);
                m.look()
            }
              , H = function(a) {
                return f.isString(a) && "reset" === a ? (x.defaults.cards = {},
                !1) : f.isObject(a) ? (a.hasOwnProperty("cards") && f.isObject(a.cards) && (x.defaults.cards = f.extend({}, x.defaults.cards, a.cards)),
                a.hasOwnProperty("recommend") && (u.notify("media.recommend.options", null, a.recommend, y.media),
                f.each(y.media, function(a) {
                    u.notify("media.recommend.add", a)
                })),
                void (a.hasOwnProperty("integrations") && r.configure(a.integrations))) : !1
            }
              , I = function(a, b) {
                f.isFunction(a) && (b = a,
                a = null),
            ...
            u.on("found", function(a) {
                a.cards && a.cards.length && d.cards.multi(a.cards, x.defaults.cards, u),
                a.buttons && a.buttons.length && f.each(a.buttons, function(a) {
                    B(a)
                }),
            ...
            u.on("card.rendered", function(a, b) {
                v.on("viewable", a, f.bind(function() {
                    this.send("card.view")
                }, b))
            }),
            u.on("card.rendered", function(a, b) {
                if (!x.shared)
                    return !1;
                if (!b.query || !b.query.url)
                    return !1;
                var c = f.hash(b.query.url);
                return c !== x.shared ? !1 : (x.shared = null,
            ...
            u.on("pinterest.log", function() {
                ...
                i.script("https://log.pinterest.com/?" + l.createQuery(a), function() {
            ...
            var K = function(a, b) {
              ...
              , O = function() {
                var a = [];
                window.embedly && f.isFunction(window.embedly) && f.isArray(window.embedly.q) && (a = window.embedly.q),
                ...
                m.connect(u),
                i.bind(m.look),
                f.isFunction(window.onEmbedlyReady) && window.onEmbedlyReady.apply(this, [window.embedly])
            };
            s.allowed(window.location.toString()) ? O() : (window.embedly = function() {}
            ,
            f.each(["card", "button", "modal", "slideshow", "look", "defaults"], function(a) {
        ...
        conf: [function(a, b, c) {
            !function(a) {
                ...
                a.EMB_ORIGIN = (a.EMB_HTTPS ? "https" : "http") + "://cdn.embedly.com",
                a.EMB_ORIGIN_BASE = a.EMB_ORIGIN + "/",
                a.EMB_ASSET_VERSION = "f9336692",
